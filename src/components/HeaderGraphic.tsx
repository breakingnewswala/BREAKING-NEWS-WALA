...
export const HeaderGraphic: React.FC<HeaderGraphicProps> = ({
  ...
  return (
    <div className="absolute top-0 inset-x-0 z-20 pointer-events-none select-none flex items-start justify-between">
      {/* 1. Left: Official "ब्रेकिंग न्यूज़वाला" Logo Box */}
      <div className="pt-3.5 pl-3.5 sm:pt-4 sm:pl-4">
        <div className="bg-[#FFE600] border-2 border-[#D91A2A] rounded-xl px-2.5 sm:px-3 py-1.5 sm:py-2 shadow-xl flex items-center gap-2 sm:gap-2.5 max-w-[220px] sm:max-w-[260px] pointer-events-auto">
          {/* Blue Globe Icon */}
          ...
          {/* Text: ब्रेकिंग न्यूज़वाला + Tagline */}
